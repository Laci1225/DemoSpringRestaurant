...
public class RestaurantUpdateDto {
    ...
    public RestaurantUpdateDto(String name, String owner, String address, String email, String phoneNumber, Integer numberOfTables, Boolean isVegan, Boolean canDeliver) {
        this.name = name;
        this.owner = owner;
